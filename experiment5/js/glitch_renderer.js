...
function setup() {
  ...
  let inspirationCanvas = createGraphics(width, height);
  inspirationCanvas.image(currentInspiration.image, 0, 0, width, height);
  document.getElementById("inspiration").innerHTML = "";
  let imgEl = document.createElement("img");
  imgEl.src = inspirationCanvas.canvas.toDataURL();
  imgEl.width = width;
  imgEl.height = height;
  document.getElementById("inspiration").appendChild(imgEl);
